...
```python
pytorch==1.12	# https://pytorch.org/get-started/previous-versions/#v1120
onnx==1.10.1
...
```bash
python tools/train.py --config anomalib/models/patchcore/config_custom_data.yaml	# stuck in 72%
python tools/train.py --config anomalib/models/padim/config_custom_data.yaml		# fast
python tools/train.py --config anomalib/models/dfm/config_custom_data.yaml
python tools/train.py --config anomalib/models/dfkde/config_custom_data.yaml
```

>  max_epochs>1

```shell
python tools/train.py --model anomalib/models/cflow/config_custom_data.yaml
python tools/train.py --model anomalib/models/ganomaly/config_custom_data.yaml
python tools/train.py --model anomalib/models/stfpm/config_custom_data.yaml
```
...
## Exporting Model to ONNX or Torchscript or OpenVINO IR
...
`python tools/export.py  --config anomalib/models/patchcore/config.yaml --weights results/patchcore/mvtec/bottle/weights/model.ckpt --img_size=[224,224] --openvino`
