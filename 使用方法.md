...
```bash
python tools/train.py --config anomalib/models/patchcore/config_custom_data.yaml
python tools/train.py --config anomalib/models/padim/config_custom_data.yaml
