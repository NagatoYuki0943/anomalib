...
```shell
python tools/train.py --model anomalib/models/cflow/config.yaml
python tools/train.py --model anomalib/models/ganomaly/config.yaml
python tools/train.py --model anomalib/models/stfpm/config.yaml
```
